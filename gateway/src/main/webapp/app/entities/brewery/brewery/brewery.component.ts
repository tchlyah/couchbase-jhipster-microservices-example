...
export class BreweryComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.breweryService
            ...
            .subscribe(
                (res: HttpResponse<IBrewery[]>) => this.paginateBreweries(res.body, res.headers),
    ...
    trackId(index: number, item: IBrewery) {
        return item.id;
    }
    ...
    private paginateBreweries(data: IBrewery[], headers: HttpHeaders) {
