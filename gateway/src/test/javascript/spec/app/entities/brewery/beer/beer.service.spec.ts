    ...
    describe('Beer Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'brewery/api/beers';
                expect(req.request.url).toEqual(resourceUrl + '/' + '123');
            });

            it('should create a Beer', () => {
                service.create(new Beer(null)).subscribe(received => {
            ...
            it('should update a Beer', () => {
                service.update(new Beer('123')).subscribe(received => {
